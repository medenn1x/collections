...
/**
 * <p>An internal implementation of an unmodifiable {@link LongSet} backed by an
...
public class ArrayLongSet extends UnmodifiablePrimitiveCollection<Long,long[]
    ...
    /**
     * <p>Returns an unmodifiable long set backed by the contents of the specified
     * array. Note that the returned set may or may not be an instance of
     * {@link ArrayLongSet}, but it will always implement
     * {@link net.arinoru.util.views.UnmodifiableView}.</p>
     * @implNote <p>When returning an actual {@link ArrayLongSet}, this method will
     * create a defensive copy of the specified array. If the specified array has only
     * one element, this method will return a {@link LongSingleton} instead. If the
     * specified array has no elements, this method will return an instance of
     * {@link EmptyLongSet}.</p>
     * @param a array containing elements to back the set
     * @return unmodifiable long set backed by the array's elements
     ...
     * {@link ArrayLongSet}, but it will always implement
     * {@link net.arinoru.util.views.UnmodifiableView}.</p>
     * @implNote <p>When returning an actual {@link ArrayLongSet}, the set will
     ...
     * by {@link LongCollection#toPrimitiveArray()}. Known implementations may
     ...
     * @return unmodifiable long set backed by the collection's elements
    ...
    /**
     * <p>Creates a {@code Spliterator.OfLong} over the elements in this set.</p>
     * @implNote <p>This method relies on the
     * {@link Spliterators#spliterator(long[], int)} method. The returned
     ...
     * @implNote <p>This method creates a {@code LongStream} over the backing
     ...
     * @throws ArrayStoreException if the runtime type of {@link Long} is not
