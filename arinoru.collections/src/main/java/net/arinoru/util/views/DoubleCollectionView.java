...
/**
 * <p>An internal implementation of a double collection view. In the normal course,
 ...
 * {@link AbstractDoubleCollectionView} as most implementing classes will neither
...
public class DoubleCollectionView extends AbstractDoubleCollectionView {
    ...
    /**
     * <p>Create a double collection view with the specified backing collection and
     * forward type.</p>
     ...
     * collection must be a {@link DoubleCollection}.</p>
    ...
    /**
     * <p>An internal implementation of a (possibly serializable) double collection
     * view. If the backing collection is serializable, this view will also be
     * serializable.</p>
     * <p>While this class is not declared {@code abstract}, it is unlikely to be
     * useful without being extended. It is provided as an alternative to
     * {@link AbstractDoubleCollectionView} as most implementing classes will
    ...
    public static class Serializable extends AbstractDoubleCollectionView
        ...
        /**
         * <p>Create a (possibly serializable) double collection view with the
         ...
         * the backing collection must be a {@link DoubleCollection}.</p>
    ...
    /**
     * <p>An internal implementation of an unmodifiable double collection view.</p>
     */
    public static class Unmodifiable extends DoubleCollectionView
            implements UnmodifiableView {
        /**
         * <p>Create an unmodifiable double collection view with the specified
     ...
     * double collection view. If the backing collection is serializable, this view
     * will also be serializable.</p>
     */
    public static class SerializableUnmodifiable extends Serializable
            implements UnmodifiableView {
        /**
         * <p>Create an unmodifiable (possibly serializable) double collection view
