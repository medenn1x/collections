...
/**
 * <p>An internal implementation of a double iterator view. This class defines
 ...
 * {@link OfDouble} interface provides a default
 ...
 *     {@link OfDouble} interface are forwarded
 ...
 *     {@link PrimitiveIterator} or {@link OfDouble}) and do
...
public abstract class AbstractDoubleIteratorView
     ...
     * implementation from
     * {@link OfDouble#forEachRemaining(Consumer)} is used.
     * </p>
     ...
     * request is forwarded to the backing iterator; otherwise, the default
     * implementation from
     * {@link OfDouble#forEachRemaining(Object) OfDouble.forEachRemaining(T_CONS)}
     * is used.</p>
     * @param action The action to be performed for each element
     * @throws NullPointerException if the specified action is null
     */
     ...
     * @implNote <p>If forwarding type is {@link ForwardingType#PURE}, the
     * request is forwarded to the backing iterator; otherwise, the default
     * implementation from {@link OfDouble#next()} is used.</p>
    ...
    /**
     * <p>Returns the next {@code double} element in the iteration.</p>
