...
/**
 * <p>An internal implementation of a long iterator view. This class defines
 ...
 * {@link OfLong} interface provides a default
 ...
 *     {@link OfLong} interface are forwarded
 ...
 *     {@link PrimitiveIterator} or {@link OfLong}) and do
...
public abstract class AbstractLongIteratorView
     ...
     * implementation from
     * {@link OfLong#forEachRemaining(Consumer)} is used.
     * </p>
     ...
     * request is forwarded to the backing iterator; otherwise, the default
     * implementation from
     * {@link OfLong#forEachRemaining(Object) OfLong.forEachRemaining(T_CONS)}
     * is used.</p>
     * @param action The action to be performed for each element
     * @throws NullPointerException if the specified action is null
     */
     ...
     * @implNote <p>If forwarding type is {@link ForwardingType#PURE}, the
     * request is forwarded to the backing iterator; otherwise, the default
     * implementation from {@link OfLong#next()} is used.</p>
    ...
    /**
     * <p>Returns the next {@code long} element in the iteration.</p>
