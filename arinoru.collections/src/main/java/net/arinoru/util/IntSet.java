...
public interface IntSet extends PrimitiveSet<Integer,int[], IntConsumer,
     ...
     * that {@code Objects.equals(t, e)}. If this set already contains the element,
     ...
     * @see IntCollection#addAll(Collection)
     * @see #add(Integer)
     */
     ...
     * @see IntCollection#addAll(IntCollection)
     * @see #addInt(int)
     */
     ...
     * @see IntCollection#containsAll(Collection)
     * @see #contains(Object)
     */
     ...
     * @see IntCollection#containsAll(IntCollection)
     * @see #containsInt(int)
     */
     ...
     *             must be non-null
     * @return an {@code IntSet} containing the elements of the given collection
     ...
     * @return an {@code IntSet} containing the specified elements
     ...
     * @see #removeInt(int)
     * @see IntCollection#remove(Object)
     */
     ...
     * is not supported by this set
     * @see #remove(Object)
     * @see IntCollection#removeInt(int)
     */
     ...
     * incompatible with the specified collection (optional)
     * @throws NullPointerException if the specified collection is null
     * @see #retainAll(IntCollection)
     * @see IntCollection#retainAll(Collection)
     * @see #remove(Object)
     */
     ...
     * @see IntCollection#retainAll(IntCollection)
     * @see #removeInt(int)
     */
