...
public interface LongCollection extends PrimitiveCollection<Long,long[],LongConsumer,
     ...
     * {@code addLong(element.longValue())}.</p>
     ...
     * the collection is an instance of {@code LongCollection}, and if so will pass
     * it to {@link #addAll(LongCollection)}. Otherwise, it iterates over all
     ...
     * specified collection, calling {@code addLong} with each element, and returns
     ...
     * @implSpec <p>The default implementation checks whether the runtime type of the
     * specified collection is an instance of {@code LongCollection}, and if so
     * passes it to {@link #containsAll(LongCollection)}. Otherwise, it is equivalent
     ...
     * the specified collection.</p>
     * @implSpec <p>The default implementation is equivalent to
     * {@code collection.primitiveStream().allMatch(this::containsLong)}.</p>
     * @param collection collection to be checked for containment in this collection
     * @return {@code true} if this collection contains all elements in the
     * specified collection
     * @throws NullPointerException if the specified collection is null.
     ...
     * {@code element == e}.</p>
     * @implSpec <p>The default implementation is equivalent to
     * {@code primitiveStream().anyMatch(e -> e == element)}.</p>
     ...
     * {@code LongCollection}, and if so passes it to
     * {@link #removeAll(LongCollection)}; otherwise it is
     * equivalent to {@code removeIfLong(collection::contains)}.</p>
     ...
     * collections will contain no elements in common after the call.</p>
     * @implSpec <p>The default implementation is equivalent to
     * {@code removeIfLong(collection::containsLong)}.</p>
     * @param collection collection containing elements to be removed from this
     *                  collection
     * @return {@code true} if this collection changed as a result of the call
     * @throws UnsupportedOperationException if the {@code removeAll} operation
     ...
     * <p>Removes a single instance of the specified element from this collection,
     * if it is present (optional operation). More formally, removes an element
     * {@code e} such that {@code element == e}, if this collection
     * contains one or more such elements. Returns {@code true} if this collection
     * contained the specified element (or equivalently, if this collection changed
     * as a result of the call).</p>
     * <p>Implementations may optionally return {@code false} when the specified
     ...
     * @implSpec <p>The default implementation checks the runtime type of the
     * collection to determine if it is an instance of {@code LongCollection}, in
     * which case it passes it to {@link #retainAll(LongCollection)}; otherwise it
     * is equivalent to {@code removeIfLong(t -> !collection.contains(t))}.</p>
     ...
     * specified collection.</p>
     * @implSpec <p>The default implementation is equivalent to
     * {@code removeIfLong(t -> !collection.containsLong(t))}.</p>
     * @param collection collection containing elements to be retained in this
     *                  collection
     * @return {@code true} if this collection changed as a result of the call
     * @throws UnsupportedOperationException if the {@code retainAll} operation is
